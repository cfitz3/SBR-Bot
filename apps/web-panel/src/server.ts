...
export async function startPanelServer(app: PanelApp): Promise<PanelServer> {
  ...
  async function handleAction(
    ...
    switch (name) {
      ...
      case "config.triggers":
        return sendMutation(res, await m.saveTriggers(session, guildId, b));
      ...
      case "event.board.publish":
        return sendMutation(res, await m.publishEventBoard(session, guildId, b["eventId"]));
      case "member.role":
