 ...
 */
export function boardPreview(result: PageResult<EventsVM>, now: Date = new Date()): PageResult<BoardPreviewVM> {
  ...
  if (result.data === null) return { access: result.access, data: null };
